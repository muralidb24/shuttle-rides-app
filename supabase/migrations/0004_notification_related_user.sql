-- Adds related_user_id to notifications so the app can show who a
-- notification is about (and let the user contact them directly), and
-- populates it from the three RPCs that create ride-related notifications.
...
begin
  ...
  values (v_requester_id, 'ride_accepted', 'Ride confirmed', v_driver_name || ' will give you a ride.', v_request_id, v_driver_id);
end;
$$;
